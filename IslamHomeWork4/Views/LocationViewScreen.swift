                ...
                ZStack {
                    VStack(alignment: .leading) {
                        CustomTextView(text: "Choose delivery location",
                                       size: 18,
                                       fontWeight: .bold).padding(.top,35)
                        ...
                        CustomTextView(text: "Saved Addresses",             size: 18,
                                       fontWeight: .bold).padding(.top,15)
    ...
    var body: some View {
        VStack (alignment: .leading) {
            HStack {
                ...
                HStack {
                    VStack(alignment: .leading ) {
                        CustomTextView(text: text, size: 16, fontWeight: .medium)
                        CustomTextView(text: text2, size: 12,foregroundColor: .black.opacity(0.5))
                    }
                    if dot3 {
